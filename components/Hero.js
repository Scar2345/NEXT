...
export default function Hero() {
  return (
    <div className='py-4 md:py-10 flex flex-col gap-006 sm:gap-8'>
      <h1 className={' spacing text-5xl sm:text-6xl md:text-7xl text-center lg:text-7xl ' + fugaz.className}>
        <span className='textGradient'>Broodl  </span>helps you track your  <span className='textGradient'>daily  </span>mood!
      </h1>
      <p className='spacing subtext text-lg sm:text-xl md:text-2xl text-center w-full mx-auto max-w-[600px]'>
